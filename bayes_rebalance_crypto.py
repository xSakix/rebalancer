...
def compute_rebalance_likehood(data,data2, max_iter=100):
    like = None
    counts = []
    best = 0.
...
def compute_buy_hold_likehood(data, data2, max_iter=100):
    like = None
    counts = []
    best = 0.
    for i in range(max_iter):
...
p_grid_reb, like_reb, counts_reb, best_reb = compute_rebalance_likehood(data,data2, max_iter)
...
p_grid_bah, like_bah, counts_bah, best_bah = compute_buy_hold_likehood(data,data2, max_iter)
